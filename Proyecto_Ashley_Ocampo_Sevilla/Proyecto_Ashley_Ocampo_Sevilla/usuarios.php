  ...
  <div align="center">
   <table width="549" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
     ...
     <td rowspan="2" colspan="2" width="542" height="27" bgcolor="#597F20" class="class1">&nbsp;&nbsp;Usuarios</td>
     <td width="1" bgcolor="AAAAAA"></td>
     ...
     <td colspan="2" bgcolor="FFFFFF">
      <table width="542" border="0" cellpadding="17" cellspacing="0">
       <tr>
		...
		<input name="nombre" type= "text" value= "" required placeholder= "Nombre"/> </br></p>
		Digite numero de cedula:
		<input type="number" name ="cedula" value="" required placeholder= "Cedula"/> </br></p>
		Genero:
		<input name="genero" type= "radio" value= "Femenino" required placeholder= "Genero"/> Femenino &nbsp;
		<input name="genero" type= "radio" value= "Masculino" required placeholder= "Genero"/> Masculino </br>
		Fecha de registro:
		<input name="fecha" type= "date" value= "" required placeholder= "Fecha"/> </br></p>
		Estado:
		<input name="estado" type= "radio" value= "Activo" required placeholder= "Estado"/> Activo &nbsp;
		<input name="estado" type= "radio" value= "Inactivo" required placeholder= "Estado"/> Inactivo </br>
		Digite su usuario:
		<input name="usuario" type= "text" value= "" required placeholder= "Usuario"/> </br></p>
		Indique la contrasena:
		<input type="password" name ="clave" value="" required placeholder= "Clave"/> </br></p>
		...
		<form name ="datos" method ="POST" action= "">
		<table border="0" windth="20%" align="center">
	    <a href= "mostrarUsuarios.php">Mostrar Usuarios</a> </p>
...
$query = "INSERT INTO usuario VALUES ('$_REQUEST[nombre]', '$_REQUEST[cedula]', '$_REQUEST[genero]',  '$_REQUEST[fecha]', '$_REQUEST[estado]', '$_REQUEST[usuario]', '$_REQUEST[clave]')";

if (mysqli_query($link, $query))
	echo "<script language='JavaScript'>alert('Usuario se agrego correctamente');</script>";
else echo "<script language='JavaScript'>alert('Usuario no se agrego correctamente');</script>";
mysqli_close($link);
}
?>
